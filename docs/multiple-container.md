  ...
  4. The docker-compose.yml file that starts your `BoldBI`  and a separate `PostgreSQL` instance with volume mounts for data persistence:
      ...
      services:
        id-web:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/bold-identity:7.9.50
          restart: on-failure
          environment:
        ...
        id-api:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/bold-identity-api:7.9.50
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
        ...
        id-ums:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/bold-ums:7.9.50
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-web:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/boldbi-server:7.9.50
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-api:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/boldbi-server-api:7.9.50
          restart: on-failure
          volumes:
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-jobs:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/boldbi-server-jobs:7.9.50
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-dataservice:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/boldbi-designer:7.9.50
          restart: on-failure
          environment:
        ...
        bi-etl:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/bold-etl:7.9.50
          restart: on-failure
          volumes:
            - boldservices_data:/application/app_data
          networks:
