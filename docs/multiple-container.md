  ...
  4. The docker-compose.yml file that starts your `BoldBI`  and a separate `PostgreSQL` instance with volume mounts for data persistence:
      ...
      services:
        id-web:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/bold-identity:14.1.11
          restart: on-failure
          environment:
        ...
        id-api:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/bold-identity-api:14.1.11
          restart: on-failure
          environment:
            - DEPLOY_MODE=docker_multi_container
          volumes: 
        ...
        id-ums:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/bold-ums:14.1.11
          restart: on-failure
          environment:
            - DEPLOY_MODE=docker_multi_container
          volumes:
        ...
        bi-web:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/boldbi-server:14.1.11
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-api:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/boldbi-server-api:14.1.11
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-jobs:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/boldbi-server-jobs:14.1.11
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-dataservice:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/boldbi-designer:14.1.11
          restart: on-failure
          volumes:
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-etl:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/bold-etl:14.1.11
          restart: on-failure
          volumes:
            - boldservices_data:/application/app_data
          networks:
        ...
        bold-ai:
          ...
          image: us-docker.pkg.dev/boldbi-294612/boldbi/bold-ai:14.1.11
          restart: on-failure
          volumes:
            - boldservices_data:/application/app_data
          networks:
