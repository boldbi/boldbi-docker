  ...
  4. The docker-compose.yml file that starts your `BoldBI`  and a separate `PostgreSQL` instance with volume mounts for data persistence:
      ...
      services:
        id-web:
          ...
          image: gcr.io/boldbi-294612/bold-identity:6.12.12
          restart: on-failure
          environment:
        ...
        id-api:
          ...
          image: gcr.io/boldbi-294612/bold-identity-api:6.12.12
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
        ...
        id-ums:
          ...
          image: gcr.io/boldbi-294612/bold-ums:6.12.12
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-web:
          ...
          image: gcr.io/boldbi-294612/boldbi-server:6.12.12
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-api:
          ...
          image: gcr.io/boldbi-294612/boldbi-server-api:6.12.12
          restart: on-failure
          volumes:
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-jobs:
          ...
          image: gcr.io/boldbi-294612/boldbi-server-jobs:6.12.12
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
        ...
        bi-dataservice:
          ...
          image: gcr.io/boldbi-294612/boldbi-designer:6.12.12
          restart: on-failure
          environment:
