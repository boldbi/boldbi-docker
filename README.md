...
| `11.2.7-focal`     | Ubuntu 24.04  (amd64, arm64)       | 03/13/2025 | This tag is intended for production use. Select this variant if you prefer Ubuntu as the base image for your deployment. |
