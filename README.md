...
| `11.1.5`, `latest` | Debian 12  (amd64,arm64)    | 02/14/2025 | This tag is intended for production use. Select this variant if you prefer Debian as the base image for your deployment. |
| `11.1.5-alpine`    | Alpine 3.13  (amd64, arm64)  | 02/14/2025 | This tag is intended for production use. Select this variant if you prefer Alpine as the base image for your deployment. |
| `11.1.5-focal`     | Ubuntu 22.04  (amd64, arm64)       | 02/14/2025 | This tag is intended for production use. Select this variant if you prefer Ubuntu as the base image for your deployment. |
